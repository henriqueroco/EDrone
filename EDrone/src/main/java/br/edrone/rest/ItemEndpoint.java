...
public class ItemEndpoint
{
   ...
   {
      TypedQuery<Item> findByIdQuery = em.createQuery("SELECT DISTINCT i FROM Item i LEFT JOIN FETCH i.produto LEFT JOIN FETCH i.venda WHERE i.id = :entityId ORDER BY i.id", Item.class);
